...
void LogDemonsReg_testfun::_gradient(){
const char* FixPath = "C:\\Users\\Martin\\Documents\\gpu_diffeomorphic_logdemons_private\\test_data\\gradient\\data\\F.dat";
...
saveImage<float>(uxf, dim, "C:\\Users\\Martin\\Documents\\gpu_diffeomorphic_logdemons_private\\test_data\\gradient\\cpu_results\\ux_cpu.bin");
saveImage<float>(uyf, dim, "C:\\Users\\Martin\\Documents\\gpu_diffeomorphic_logdemons_private\\test_data\\gradient\\cpu_results\\uy_cpu.bin");
saveImage<float>(uzf, dim, "C:\\Users\\Martin\\Documents\\gpu_diffeomorphic_logdemons_private\\test_data\\gradient\\cpu_results\\uz_cpu.bin");
}
...
void LogDemonsReg_testfun::_jacobian(){
	/*
	Input: sx, sy, sz, F, Mp
	...
	*/
	...
	saveImage<float>(jac, dim, "C:\\Users\\Martin\\Documents\\gpu_diffeomorphic_logdemons_private\\test_data\\jacobian\\cpu_results\\jac.bin");
